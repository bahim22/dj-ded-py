...
def hello_there_old(request, name):
    ...
    # match_object (v 1 only had match_object)
    ...
    # (pattern: AnyStr@match, string: AnyStr@match, flags: _FlagsType = ...) ->
    # Match[AnyStr@match] | None
...
# Return an HttpResponse whose content
